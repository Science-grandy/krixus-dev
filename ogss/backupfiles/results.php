...
$(document).ready(function() {
    ...
    function reattachEventListeners() {
        $('.view_result').off('click').on('click', function() {
            ...
            uni_modal("<div style='display: flex; justify-content:center; align-items:center; gap: 10px; width: 100%'><img src='assets/uploads/ogss.jpg' width='50'><br><b><?php echo $school_name ?> - Result Sheet</b></div>", "view_result.php?id=" + resultId, 'large');
        });
