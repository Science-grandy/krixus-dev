			...
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody id="class-list">
					...
					<tr>
						...
						<td><b><?php echo strtoupper($row['level']) ?></b></td>
						<td><b><?php echo strtoupper($row['section']) ?></b></td>
...
<script>
	$(document).ready(function(){
	    ...
	    $('#class-list').on('click', '.manage_class', function() {
	        uni_modal("Manage class", "manage_class.php?id=" + $(this).attr('data-id'));
	    });
	    
	    $('#class-list').on('click', '.delete_class', function() {
