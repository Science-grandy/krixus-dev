	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			...
			<!-- <div class="card-tools mr-2">
				<button class="btn btn-block btn-sm btn-danger btn-flat">Delete All</button>
			</div> -->
			<div class="card-tools mr-2">
				<a class="btn btn-block btn-sm btn-secondary btn-flat border-secondary " href="./index.php?page=upload&role=student"></i>Upload CSV</a>
			</div>
		</div>
			...
			<table class="table table-hover table-bordered" id="list">
				...
				<tbody id="student-list">
					...
					<tr>
						...
						<td class=""><?php echo $row['reg_no'] ?></td>
...
<script>
	$(document).ready(function(){
	    ...
	    $('#student-list').on('click', '.view_student', function() {
	        uni_modal("Student's Details", "view_student.php?id=" + $(this).attr('data-id'),"large")
	    });
	    
	    $('#student-list').on('click', '.delete_student', function() {
